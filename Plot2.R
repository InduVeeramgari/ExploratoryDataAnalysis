## This Code generates Plot2 for Exploratory Data Analysis Assignement-2
if(!exists("NEI")){
...
# Did total emissions from PM2.5 decreased in the Baltimore City, Maryland (fips == "24510") from 1999 to 2008? 
